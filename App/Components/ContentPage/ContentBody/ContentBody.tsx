    ...
    doRender(): React.ReactElement<{}> {
        return  <div>
                ...
                <div className="row">
                    ...
                    quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</h4><br />
                ...
                <div className="row slideanim">
                    ...
                    <h4 className={styles.hardWork}>HARD WORK</h4>
                    <p>Lorem ipsum dolor sit amet..</p>
                    </div>
                </div>
                </div>
                ...
                <div id="myCarousel" className="carousel slide text-center" data-ride="carousel">
                    ...
                    <div className="item active">
                        ...
                        <span className={styles.normal}>Michael Roe, Vice President, Comment Box</span></h4>
                    </div>
                    <div className="item">
                        <h4>"One word... WOW!!"<br /><span className={styles.normal}>John Doe, Salesman, Rep Inc</span></h4>
                    </div>
                    <div className="item">
                        <h4>"Could I... BE any more happy with this company?"<br />
                        <span className={styles.normal}>Chandler Bing, Actor, FriendsAlot</span></h4>
                    </div>
                    </div>
